...
// frontend/src/Components/AuthModal.jsx
// ✅ FIXED: Better error handling to show specific backend messages
...
const AuthModal = ({ mode, onClose, onSuccess, onSwitchMode }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ FIXED: Extract specific error messages from backend
      ...
      // Get error from response data errors object (validation errors)
