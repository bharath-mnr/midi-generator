...
// ✅ FIXED: Proper email verification without refresh() method
package com.midigenerator.service;
...
public class AuthService {
    ...
    public AuthResponse login(LoginRequest request) {
        ...
        log.info("🔐 User {} logged in - Email verified: {}", user.getEmail(), user.getEmailVerified());
    ...
    public EmailVerificationResponse verifyEmail(VerifyEmailRequest request) {
        try {
            ...
            // ✅ Set verified and flush to database immediately
            user.setEmailVerified(true);
            User savedUser = userRepository.saveAndFlush(user);

            log.info("✅ User {} email verified and saved. Verified status: {}",
                    savedUser.getEmail(), savedUser.getEmailVerified());
